...
import { MoreVertical, Video, Image, Eye, Edit, Trash2, Clock, Building } from 'lucide-react';
import { format } from 'date-fns';

export default function LibraryItemCard({ item, organizationName, onView, onEdit, onDelete }) {
      ...
      <CardContent className="p-4 flex-1">
        <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex flex-wrap gap-1">
              ...
              {item.labels.length > 2 && <Badge variant="outline">+{item.labels.length - 2}</Badge>}
            </div>
        </div>
