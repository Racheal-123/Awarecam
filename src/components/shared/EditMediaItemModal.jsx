        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-start gap-4">
            ...
            <Textarea 
              ...
              className="col-span-3" 
              placeholder="Add a detailed description for future reference"
              rows={3}
            />
          </div>
          <div className="grid grid-cols-4 items-start gap-4">
            ...
            <div className="col-span-3">
              <div className="flex gap-2">
                ...
                <Button 
                  ...
                  disabled={!currentLabel || labels.includes(currentLabel)}
                >
              ...
              <p className="text-xs text-slate-500 mt-1">
                Labels help you find this media later. Press Enter to add.
              </p>
            </div>
          </div>
        </div>
